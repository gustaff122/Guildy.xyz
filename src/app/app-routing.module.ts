...
const routes: Routes = [
  ...
  { path: 'welcome', component: MainLayoutComponent, resolve: [MainLayoutResolver], canActivate: [AngularFireAuthGuard], data: { authGuardPipe: redirectUnauthorizedToAuth }, loadChildren: () => import('./pages/main-pages/main-pages.module').then(m => m.MainPagesModule) },
